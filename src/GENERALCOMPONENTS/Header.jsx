  ...
  return (
    <header className="fixed top-0 left-0 right-0 flex flex-col md:flex-row items-center justify-between p-4 bg-red-600 text-white shadow-lg space-y-2 md:space-y-0 z-50">
      ...
      <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4">
        ...
        {showUserMenu && (
          <div className="absolute top-14 right-1 w-48 bg-white text-red-600 shadow-lg rounded-lg z-10">
            <ul>
              <li className="px-4 py-2 hover:bg-red-100 cursor-pointer" onClick={() => setShowUserMenu(false)}>
