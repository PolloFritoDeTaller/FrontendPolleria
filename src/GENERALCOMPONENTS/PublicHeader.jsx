...
const PublicHeader = () => {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 right-0 flex flex-col md:flex-row items-center justify-between p-4 bg-red-600 text-white shadow-lg space-y-2 md:space-y-0 z-50 md:relative">
            ...
            {/* Contenido debajo del encabezado, ajustamos con margen superior */}
